...
def dbreinit(logger,connection,bool): #pass in mysql = MySQL(app) from init.py
    ...
    memberstable=   "create table Members (unique_id integer(16)not null,mem_username varchar(25)not null,mem_email VARCHAR(50),mem_password varchar(170) default null, primary key (unique_id, mem_username),foreign key (unique_id) references Users(unique_id)on update cascade on delete cascade,unique (mem_username));"
    ...
    admintable=     "CREATE TABLE Administrator (unique_id integer(16) not null,admin_username varchar(25) not null,admin_email varchar(50),admin_password varchar(170) default null,primary key (unique_id, admin_username),foreign key (unique_id) references Users(unique_id)on update cascade on delete cascade,unique (admin_username));"
