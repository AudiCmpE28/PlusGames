...
#def parse_through_csv(connection,static/csv/steam_game.csv):
...
#    #query
#    query = "INSERT INTO 'game'('game_id','g_company','game_n','genre','rating','release_date','price') values (%s,%s,%s,%s,%s,%s,%s)"
